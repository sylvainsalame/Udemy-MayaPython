...
def main():
    parser = argparse.ArgumentParser(description="This is a batch renamer",
                                     usage="To replace all files with hello with goodby instead: python commandLine.py hello goodbye")

    parser.add_argument('inString', help="The word to replace")
    parser.add_argument('outString', help="The word to replace if with")
